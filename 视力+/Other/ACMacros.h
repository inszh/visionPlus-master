...
#define UPDATEGROUPINFOARRY  @"UPDATE_GROUP_INFO.txt"
...
// 标注中的规范
/** 标准色 ---- B 表示背景色 */
#define k_B1 LHColor(242,242,242)
#define k_B2 LHColor(255,252,255)
...
/** 间隔线 --- L 表示line */
#define k_L LHColor(242,242,242)
#define k_L1 LHColor(242,242,242)
#define k_L2 LHColor(221,221,221)
#define k_L3 LHColor(221,221,221)
 ...
 * 字体大小1.4.1
 */
#define k_size_blod_F1 [UIFont boldSystemFontOfSize:10]
#define k_size_blod_F2 [UIFont boldSystemFontOfSize:12]
#define k_size_blod_F3 [UIFont boldSystemFontOfSize:15]
#define k_size_blod_F4 [UIFont boldSystemFontOfSize:18]
#define k_size_blod_F5 [UIFont boldSystemFontOfSize:18]
#define k_size_F1 [UIFont systemFontOfSize:10]
#define k_size_F2 [UIFont systemFontOfSize:12]
#define k_size_F3 [UIFont systemFontOfSize:15]
#define k_size_F4 [UIFont systemFontOfSize:18]
#define k_size_F5 [UIFont systemFontOfSize:20]
/**
 *颜色1.4.1
 */
#define k_P1 LHColor(61,134,248)//蓝色
#define k_P2 LHColor(96,156,249)
#define k_P3 LHColor(255,87,34)//红色
#define k_P4 LHColor(0,185,48)
#define k_P5 LHColor(68,68,68)//有点类似黑色,灰啦吧唧的
#define k_P6 LHColor(136,136,136)
#define k_P7 LHColor(187,187,187)
#define k_P8 LHColor(221,221,221)
#define k_P9 LHColor(255,255,255)//白色
#define k_Y1 LHColor(61,134,248)//蓝色
#define k_Y2 LHColor(34,34,34)
#define k_Y3 LHColor(136,136,136)
#define k_Y4 LHColor(55,115,167)
#define k_Y5 LHColor(255,33,59)//红色
//#define k_X1 LHColor(255,33,59)
#define k_X1 LHColor(216,216,216)
//文字
...
#define isLessThanIOS11         ([[[UIDevice currentDevice]systemVersion]floatValue] < 11)
...
#ifdef DEBUG
#define ZSDistributionType @"Development"
...
#else
#define ZSDistributionType @"Distribution"
